...
<h1 style="color: #444;">Paper Sequencer - Song Selection</h1>
<h3 style="color: #666;">The Paper Sequencer is an innovative project comprising of five synchronized disks that produce captivating sounds upon encountering the color black.</h3>
</div>
<p style="color: #555;">Please upload a WAV file for each of the five disks:</p>
